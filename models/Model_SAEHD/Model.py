...
""").lower()
        ...
        if self.is_first_run() or ask_override:
            ...
            self.options['optimizer'] = io.input_str ('优化器选项（adam / adabelief / lion）', default_optimizer, ['adam', 'adabelief', 'lion'], help_message="adam - 标准 Adam，省显存。adabelief - AdaBelief，精度/泛化更好但更费显存。lion - Google 2023，适合大模型，省显存。")
